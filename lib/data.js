...
export const INITIAL_AUDIT_LOGS = [
  {
    id: "LOG-1001",
    timestamp: "2026-09-05 18:30:12",
    customer: "Aarav Patel",
    amount: 2499,
    event: "payment.failed",
    diagnosis: "Transient 3DS Bank OTP Timeout",
    action: "Dispatched 1-Click Razorpay Payment Link via WhatsApp",
    explainability: "Transient bank failure detected. Direct payment link bypasses checkout friction.",
    gate: "Guardrail Passed: Bounded & Gated",
    status: "RECOVERED",
  ...
  },
  {
    ...
    diagnosis: "Cart abandoned at payment step",
    action: "Dispatched Razorpay UPI Recovery Link via WhatsApp",
    explainability: "High order value (₹5,999 > ₹500 threshold). 1-click UPI recovery link sent.",
    gate: "Guardrail Passed: Gated Money Action",
    status: "RECOVERED",
